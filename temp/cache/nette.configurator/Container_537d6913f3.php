...
class Container_537d6913f3 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	public function createServiceContainer(): Container_537d6913f3
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=db;dbname=test', 'root', 'keksdb', ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_537d6913f3 $container)
			{
